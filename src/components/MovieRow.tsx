...
interface MovieRowProps {
  ...
  function MovieRow({ title, movies, onPlay, onInfo, myList = [] as { id: number }[], toggleMyList, userProgress = {} as Record<string, { duration?: number }>, onHideProgress }: MovieRowProps) {
